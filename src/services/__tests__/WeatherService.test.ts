...
describe('WeatherService', () => {
  ...
  it('Should return formatted currentWeather from API', async () => {
  ...
  it('Should return formated CurrentWeather with empty weather', async () => {
    ...
    const { icon, description } = await WeatherService.fetchCurrentWeather(
      0,
      0,
    );
